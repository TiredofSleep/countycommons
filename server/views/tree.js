...
<header class="page">
  ...
  <div class="src">${esc(budget.meta.grand_total_note)} Click any number to see exactly where it comes from. Where the trail goes dark, it becomes a numbered issue in the <a href="/docket">docket</a>.</div>
  ${vStamp}
</header>
