...
<dialog id="rules" class="rules" aria-labelledby="rules-title">
  ...
  <ul style="padding-left:18px;display:flex;flex-direction:column;gap:7px;font-size:14px;margin:10px 0">
    ...
    <li><b>Signing is the loud version — and always your choice.</b> The count is anonymous, period. If you want to be heard by name, you can sign your answer publicly, petition-style: name and answer, nothing else. Self-signed and unverified until the tiers arrive; misused names removed on request, with removals logged.</li>
