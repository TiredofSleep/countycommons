...
<dialog id="rules" class="rules" aria-labelledby="rules-title">
  ...
  <ul style="padding-left:18px;display:flex;flex-direction:column;gap:7px;font-size:14px;margin:10px 0">
    ...
    <li><b>An anonymous count can be padded — we say so on purpose.</b> Because Tier 0 takes no verification, a determined person can inflate the raw number. That is the weakness the verification tiers (phone, residency, voter-file) exist to close. Today's counts are open sentiment, never proof — and a public signature by real name is worth more than a hundred anonymous taps.</li>
