...
**A proposal for treating access to food the way a county already treats parks, the library, and water: as shared infrastructure the community keeps up together — and an honest account of how far that idea reaches.**
...
Treat community food-growing — gardens on public land, a gleaning-and-sharing network, school and campus gardens — as a standing county service coordinated through one table, funded mostly by grants and volunteers, not new taxes.

## It already runs somewhere — with numbers

| The move | Where it already runs | The number |
|---|---|---|
| A **city** running community gardens as a public service | **Seattle P-Patch**, under the Dept. of Neighborhoods since 1973 | **91 gardens**; gardeners donated **40,000 lb** of produce to meal programs in 2023 ([seattle.gov](https://www.seattle.gov/neighborhoods/p-patch-gardening)) |
| A **county** running gardens through its Extension office | **Brown County, Wisconsin**, since 1996 | **13 gardens, 386 plots, 250+ gardeners**, funded jointly by the county, Extension, and the city ([UW–Madison Extension](https://brown.extension.wisc.edu/community-gardens/)) |
| Free land access without selling the land | **Newark's Adopt-a-Lot** ($1/year lease) and **Baltimore's** (free, revocable license) | A simple revocable license, no title transfer ([Newark](https://www.newarknj.gov/194/Adopt-a-Lot); [Baltimore](https://www.baltimorecity.gov/dhcd/developer-resident-resources/adopt-a-lot-program)) |
| A **statewide gleaning network** already in every county | **Arkansas Gleaning Project** (AR Hunger Relief Alliance + Society of St. Andrew) | **12M+ lb** gleaned, **800+ orgs**, **all 75 counties** ([arhungeralliance.org](https://arhungeralliance.org/programs/ar-gleaning-project/)) |
| Free horticulture know-how in every AR county | **Arkansas Master Gardener Program** (UA System Extension) | **93,175 education + 184,443 service hours** logged statewide in a year ([uaex.uada.edu](https://www.uaex.uada.edu/yard-garden/master-gardeners/default.aspx)) |
| School gardens feeding cafeterias | **Denver "Garden to Cafeteria"** | **5,000+ lb** into salad bars at **~250 schools** ([Slow Food USA](https://slowfoodusa.org/school-gardens/garden-cafeteria/)) |
| A coordinating body local government can adopt | **Food policy councils** (housed in government by resolution) | **283 active in the US as of 2020** ([CDC](https://www.cdc.gov/pcd/issues/2025/24_0335.htm); [Johns Hopkins CLF](https://clf.jhsph.edu/stories/structuring-your-food-policy-council)) |

USDA has already funded this channel in Arkansas once: the 2011 **People's Garden School Pilot** partnered with the **University of Arkansas** to build school gardens through Cooperative Extension ([peoplesgarden.wsu.edu](https://peoplesgarden.wsu.edu/home/project-background/)).
...
- **Put the question to the people who decide** — the priorities board and this open question, so backing is demonstrated, not asserted.
- **Track the loop in public** — if the county acts, each step (land opened, council seated, grant won) is dated and cited on [what came of it](/outcomes).
- **Keep score honestly** — how much of this is real and running versus proposed, with the food-insecurity number beside it, year over year.
